...
class COCO_keypoints(object):
    def __init__(self):
        ...
        self.images_dir = Config.COCO_ROOT_DIR 
    ...
    def __get_the_path_of_picture(self,num,picture_name):
        if num == "train":
          return self.images_dir + "train2017/"+ picture_name  #+ "train2017/" 
        else: 
          return self.images_dir + "val2017/"+ picture_name  #+ "train2017/" 
    ...
    def write_information_to_txt(self, dataset):
        ...
        with open(file=txt_file, mode="a+") as f:
            for i in range(len(image_ids_from_keypoints)):
                ...
                one_human_instance_info += self.__get_the_path_of_picture(num,image_files[image_index]) + " "
