...
from face_seg_linknet34.models.resnet50 import resnet50
...
# def load_resnet34_param(res50_module):
#     # flow.env.init()
...
#
#     start_t = time.time()
#     torch_params = torch.load('resnet34-333f7ec4.pth')
...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, pretrained=True, pretrained_model_path = ""):
        super().__init__()
        ...
        resnet = resnet50()
        #resnet = load_resnet34_param(resnet_1)
        if pretrained:
