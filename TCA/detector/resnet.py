...
def resnet50(images, trainable=True, training=True):
    weight_regularizer = flow.regularizers.l2(3.0517578125e-05)
    builder = ResnetBuilder(weight_regularizer, trainable, training, False, False, False)
