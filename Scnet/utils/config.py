...
from Scnet.utils.optimizer_util import add_optimizer_args
from Scnet.utils.ofrecord_util import add_ofrecord_args
...
def get_parser(parser=None):
    ...
    parser.add_argument("--model_load_dir", type=str,
                        #default="./model/scnet_hustcolor_90.7_top1",
                        help="model load directory if need")
    parser.add_argument("--batch_size_per_device", type=int, default=32)
    parser.add_argument("--val_batch_size_per_device", type=int, default=32)
    ...
    # inference
    parser.add_argument("--image_path", type=str, default='data/img_yellow.png', help="image path")

    # for data process
    parser.add_argument("--num_classes", type=int, default=8, help="num of pic classes")
    parser.add_argument("--num_examples", type=int,
                        default=7795, help="train pic number")
    parser.add_argument("--num_val_examples", type=int,
                        default=7800, help="validation pic number")
